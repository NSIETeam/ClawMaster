...
const zh = {
  ...
  scheduleHint: '定时检查使用 DSH 提醒；应用运行且对应会话活动时执行，关闭后的到期检查在恢复会话后继续。',
  ...
  tasks: '任务', all: '全部', running: '执行中', idle: '当前未运行', search: '搜索任务', refresh: '刷新', refreshing: '正在刷新…',
  noTasks: '还没有任务', noMatches: '没有匹配的任务', noTasksHint: '从上方描述一个目标开始。',
  ...
  untitled: '未命名任务', open: '打开', openInSidebar: '在右侧打开', error: '操作失败', retry: '重试', cancel: '取消', save: '保存', saving: '正在保存…',
...
const en: ProductCopy = {
  ...
  scheduleHint: 'DSH reminders run while the app and session are active. Due checks continue when the session resumes.', allocationHint: 'The system creates a workspace for each task. No directory selection is required.',
  ...
  tasks: 'Tasks', all: 'All', running: 'Running', idle: 'Not running', search: 'Search tasks', refresh: 'Refresh', refreshing: 'Refreshing…', noTasks: 'No tasks yet', noMatches: 'No matching tasks', noTasksHint: 'Start by describing a goal above.', loading: 'Loading sessions…', refreshError: 'Refresh failed. Please retry.', actionError: 'The action could not be completed. Please retry.',
  ...
  untitled: 'Untitled task', open: 'Open', openInSidebar: 'Open in sidebar', error: 'Action failed', retry: 'Retry', cancel: 'Cancel', save: 'Save', saving: 'Saving…', remove: 'Delete', edit: 'Edit', add: 'New', export: 'Export backup', loadingData: 'Loading data…',
