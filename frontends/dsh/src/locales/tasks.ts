...
const zh = {
  ...
  create: '建立业务任务', refresh: '刷新业务任务', more: '加载更多任务', loading: '正在读取业务任务…', empty: '还没有业务任务。先明确目标、负责人和验收标准。',
  ...
  saveDraft: '保存业务草稿', closeForm: '收起表单', savedHint: '保存后可重新打开；历史会话只能显式关联，不会自动变成已完成任务。',
  ...
  overdue: '已逾期', waiting: '等待外部条件', noDeadline: '未设期限', revision: '修订', details: '任务详情', queue: '安排执行',
  ...
  cancel: '取消任务', reopen: '重新打开', fail: '记录失败', history: '历史证据与验收', loadHistory: '读取历史记录', moreHistory: '继续读取历史',
  ...
  denied: '权限或独立审批不足；请联系有权限的成员处理。', conflict: '任务已被修改。请重新打开详情、核对最新修订后再操作。',
...
const en: Copy = {
  ...
  create: 'Create business task', refresh: 'Refresh business tasks', more: 'Load more tasks', loading: 'Loading business tasks…', empty: 'No business tasks yet. Define a goal, owner and acceptance criteria.',
  ...
  saveDraft: 'Save business draft', closeForm: 'Close form', savedHint: 'Saved drafts survive reopening. Existing sessions are linked explicitly and never inferred as completed work.',
  ...
  overdue: 'Overdue', waiting: 'Waiting on an external condition', noDeadline: 'No deadline', revision: 'Revision', details: 'Task details', queue: 'Queue for execution',
  ...
  cancel: 'Cancel task', reopen: 'Reopen task', fail: 'Record failure', history: 'Evidence and review history', loadHistory: 'Read task history', moreHistory: 'Continue history',
  ...
  denied: 'Permission or independent approval is missing. Ask an authorized member to handle this action.', conflict: 'The task has changed. Reopen details and review the current revision before continuing.',
