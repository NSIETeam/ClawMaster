...
Forms and confirmations opened before a restore keep their original generation. Their inputs remain visible, but refreshing or editing them does not authorize a write to restored records. Copy any needed draft content, cancel the form or confirmation, and reopen it to review the current records before saving.
