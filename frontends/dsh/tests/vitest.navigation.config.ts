...
export default defineConfig({
  ...
  test: {
    ...
    include: ['frontends/dsh/tests/navigation-native.client.spec.tsx', 'frontends/dsh/tests/components-native.client.spec.mjs', 'frontends/dsh/tests/onboarding.client.spec.mjs', 'frontends/dsh/tests/enterprise-restore.client.spec.tsx', 'frontends/dsh/tests/task-board.client.spec.mjs', 'frontends/dsh/tests/schedule-board.client.spec.mjs', 'frontends/dsh/tests/home-health.client.spec.mjs', 'frontends/dsh/tests/render-boundary.client.spec.mjs', 'frontends/dsh/tests/watchdog-task-replay.integration.test.ts'],
  },
});
