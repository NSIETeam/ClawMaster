...
export default defineConfig({
  ...
  test: {
    ...
    include: ['frontends/dsh/tests/navigation-native.client.spec.tsx', 'frontends/dsh/tests/components-native.client.spec.mjs', 'frontends/dsh/tests/onboarding.client.spec.mjs'],
  },
});
