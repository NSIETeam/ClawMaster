...
`
  ...
  for (const name of ['vendor/*', 'packages/*/*', 'native/system', 'native/system/packages/*', 'apps/cli', 'apps/web', 'apps/desktop-defaults', 'apps/clawmaster-sys-prompt', 'frontends/dsh', 'frontends/notes', 'frontends/office']) {
