...
const artifactPatterns = {
  ...
  product: ['frontends/dsh/dist/**/*', 'frontends/office/dist/**/*', 'frontends/office/runtime/.clawmaster-office-manifest.json', 'native/system/packages/*/bin/**/*', 'apps/desktop-tauri/dist/**/*', ...generatedIcons],
}
