...
This GitHub channel distributes desktop releases, including their bundled runtime. It does not independently update or hot-reload DSH plugins. Profile plugin management remains with [DSH profiles](../../packages/boot/app-boot/README.md); development client reloads require the [client HMR watcher](../../packages/client/hmr/README.md).
