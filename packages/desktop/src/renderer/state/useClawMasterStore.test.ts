...
describe('applyFrame 各帧分支', () => {
  ...
  it('models_list：当前模型被服务端标记不可用时清除旧选择', () => {
    ...
    push({
      type: 'models_list',
      payload: {
        models: [{ id: 'm', displayName: 'M', provider: 'clawmaster' }],
        current: 'm',
      },
    });
    push({
  ...
  it('模型切换：旧 models_list 回包不得把乐观选择跳回上一个模型', () => {
    ...
    push({
      ...
      payload: {
        models: [
          { id: 'old-model', displayName: '旧模型', provider: 'clawmaster' },
          { id: 'new-model', displayName: '新模型', provider: 'clawmaster' },
        ],
        current: 'old-model',
      },
    });
    ...
    push({
      ...
      payload: {
        models: [
          { id: 'old-model', displayName: '旧模型', provider: 'clawmaster' },
          { id: 'new-model', displayName: '新模型', provider: 'clawmaster' },
          { id: 'model-b', displayName: 'B', provider: 'clawmaster' },
        ],
        current: 'old-model',
      },
    });
  ...
  it('非当前会话的 pending 确认不覆盖当前会话模型', () => {
    ...
    push({
      ...
      payload: {
        models: [
          { id: 'model-a', displayName: 'A', provider: 'clawmaster' },
          { id: 'model-a-new', displayName: 'A2', provider: 'clawmaster' },
          { id: 'model-b', displayName: 'B', provider: 'clawmaster' },
        ],
        current: 'model-a',
      },
