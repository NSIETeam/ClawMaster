...
describe('OrganizationTree', () => {
  ...
  it('can ask ClawMaster from a direct chat with recent messages', async () => {
    ...
    const enterpriseOrganizationView = vi.fn(async () => ({
      ...
      members: [{
        ...
        clawmasterLastSeenAt: '2026-07-23T06:00:00.000Z',
      }],
      employeeCount: 2,
    }));
    ...
    const enterpriseOrganizationView = vi.fn(async () => {
      ...
      return {
        ...
        members: [{
          ...
          clawmasterLastSeenAt: '2026-07-23T05:55:00.000Z',
        }, {
          id: 'acc_3',
          username: 'bob',
          name: 'Bob',
  ...
  it('uses @clawmaster as a direct-chat shortcut instead of sending it as a message', async () => {
    ...
    fireEvent.change(input, { target: { value: '@clawmaster summarize action items' } });
