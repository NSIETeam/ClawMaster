...
describe('ModuleWorkspace drag reorder contract', () => {
  ...
  it('auto-scrolls the workspace viewport when dragging a group near its edge', () => {
    ...
    viewport.getBoundingClientRect = () => ({
      x: 0, y: 0, top: 0, left: 0, right: 320, bclawmasterm: 300, width: 320, height: 300,
      toJSON: () => ({}),
    })
    viewport.scrollTop = 100

    const bclawmastermMove = new Event('pointermove', { bubbles: true })
    Object.defineProperty(bclawmastermMove, 'clientY', { value: 295 })
    fireEvent(groupList, bclawmastermMove)
