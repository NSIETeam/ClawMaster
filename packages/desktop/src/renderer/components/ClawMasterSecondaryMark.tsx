  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <g className="claw-response-mark__ball">
          <polygon
            className="claw-response-mark__spines"
          ...
          />
          <circle className="claw-response-mark__belly" cx="11.3" cy="12.3" r="6.15" />
          <circle className="claw-response-mark__ear" cx="14.25" cy="8.25" r="1.25" />
          <path
            className="claw-response-mark__curl"
          ...
          />
          <path className="claw-response-mark__accent" d="M6.1 14.2a6.2 6.2 0 0 0 3.45 3.75" />
          <circle className="claw-response-mark__eye" cx="15.2" cy="10.05" r=".62" />
          <circle className="claw-response-mark__nose" cx="17.55" cy="11.35" r=".92" />
        </g>
      </svg>
    </span>
  );
