    ...
    const parsed = parseIncrementalUpdateManifest({
      ...
      channels: {
        patch: [{
          ...
          url: 'https://updates.example.com/clawmaster/patch-login-lease-v1.tar.zst',
          size: 4096,
          sha256: sha,
          signature,
          restart: 'app',
        ...
        kernel: [{
          ...
          url: 'https://updates.example.com/clawmaster/kernel-core-abi-2026-07.tar.zst',
          size: 8192,
          sha256: sha,
          signature,
          restart: 'server',
        ...
        component: [{
          ...
          url: 'https://updates.example.com/clawmaster/component-skills-ppt-v2.tar.zst',
          size: 2048,
          sha256: sha,
          signature,
          restart: 'none',
