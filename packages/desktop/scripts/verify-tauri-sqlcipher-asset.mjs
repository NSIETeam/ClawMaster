...
export function verifyTauriSqlCipherAsset({
  ...
  if (
    ...
    || properties.get('clawmaster:runtime') !== 'node'
    || properties.get('clawmaster:runtimeVersion') !== expectedNodeVersion
    || properties.get('clawmaster.moduleAbi') !== expectedModuleAbi
    || properties.get('clawmaster:cryptoProvider') !== expectedCryptoProvider
  ) {
