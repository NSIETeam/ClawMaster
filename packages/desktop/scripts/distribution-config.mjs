...
export const OTTO_DISTRIBUTION = 'ClawMaster';
...
export const OTTO_IDENTITY = {
  ...
  appId: 'team.nsi.clawmaster.desktop',
  protocolName: 'ClawMaster Enterprise Invite',
  protocolScheme: 'clawmaster',
  artifactToken: 'ClawMaster',
  shortcutName: 'ClawMaster',
  dataDirectoryName: 'ClawMaster',
  distributionId: 'clawmaster',
  variantEnv: null,
  macBundleId: 'team.nsi.clawmaster.desktop',
};
