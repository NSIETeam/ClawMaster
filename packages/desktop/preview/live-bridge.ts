...
const bridge = {
  ...
  appVersion(): Promise<string> { return Promise.resolve('0.0.1-preview-browser'); },
  updateCheck(): Promise<any> { return Promise.resolve({ status: 'up-to-date', currentVersion: '0.0.1-preview', latestVersion: null }); },
