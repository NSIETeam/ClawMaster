 ...
 * `~/.clawmaster/last-requests/{ts}_gemini-{kind}_{modelId}.json` so when EasyRouter
 ...
 *   - Same dir: `~/.clawmaster/last-requests/`
 ...
 */
const GEMINI_DUMP_DIR_SEGMENTS = ['.clawmaster-user', 'last-requests'] as const
