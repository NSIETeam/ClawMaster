              ...
              <head>
                ...
                <style>
                  * { margin: 0; padding: 0; box-sizing: border-box; }
                  ...
                  h1 { font-size: 24px; font-weight: 600; color: #000; margin-bclawmasterm: 12px; letter-spacing: -0.5px; }
                  p { font-size: 15px; color: #666; margin-bclawmasterm: 28px; line-height: 1.6; }
