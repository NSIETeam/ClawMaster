...
/**
 * Pure decision logic for the mid-turn injection drain. Given the
 ...
 *
 * This module lives in packages/core so both the desktop renderer and the
 * CLI (and Feishu adapter) can share the same queue decision logic.
 */
