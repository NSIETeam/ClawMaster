...
export const CLAWMASTER_CONFIG_DIR = '.clawmaster-user'
export const DEFAULT_CONTEXT_FILENAME = 'CLAWMASTER.md'
export const LEGACY_CONTEXT_FILENAME = 'CLAWMASTER.md'
...
/**
 * ClawMaster 只认自己的上下文文件 CLAWMASTER.md。
...
/** 记忆根目录(~/.clawmaster-user/memory),三层记忆(global/session)共用根。 */
...
/**
 * 全局(跨项目、跨会话)记忆文件:~/.clawmaster-user/memory/global.md。
 * 用于沉淀用户级偏好/习惯,与项目级 CLAWMASTER.md、会话级 sessions/<id>.md 三层并存。
 */
