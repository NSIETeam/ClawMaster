 ...
 * ~/.clawmaster-user/knowledge/entries.jsonl，纯本地文件，离线可用。
 * 与 save_memory（CLAWMASTER.md 追加式记忆）也互补：这里是结构化条目
...
> {
  ...
  constructor(_config?: Config) {
    super(
      ...
      'KnowledgeBase',
      `Personal local knowledge base (stored under ~/.clawmaster-user/knowledge, fully offline, no account or enterprise license required).
