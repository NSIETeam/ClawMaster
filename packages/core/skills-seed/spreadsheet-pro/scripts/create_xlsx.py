#!/usr/bin/env python3
"""ClawMaster Spreadsheet-Pro v6 — 视觉感知多布局引擎（含图​表）。python create_xlsx.py in.md out.xlsx"""
...
class R:
    ...
    def _st(self):
        ...
        self._bdr=Border(left=Side(style="thin",color=self._hex("border")),
            ...
            bclawmasterm=Side(style="thin",color=self._hex("border")))
...
def main():
    import argparse
    p=argparse.ArgumentParser(description="ClawMaster Spreadsheet-Pro v6")
