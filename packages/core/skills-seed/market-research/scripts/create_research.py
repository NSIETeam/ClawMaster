#!/usr/bin/env python3
"""
ClawMaster Market Research Pro v9
...
.wrap{{max-width:1080px;margin:0 auto;padding:40px 24px 64px}}.hero{{background:{base};color:#fff;padding:42px 40px;border-radius:12px;border-bclawmasterm:6px solid {accent}}}
.hero h1{{margin:0 0 10px;font-size:34px;letter-spacing:0}}.hero p{{margin:0;color:#d7e2ef}}section{{padding:26px 0;border-bclawmasterm:1px solid #e5e9f0}}
h2{{font-size:20px;margin:0 0 14px;color:{base}}}table{{width:100%;border-collapse:collapse;background:white;border:1px solid #e5e9f0}}th,td{{padding:10px 12px;border-bclawmasterm:1px solid #edf0f4;text-align:left;vertical-align:top;font-size:13px}}th{{background:#f9fafb;color:#475467}}
...
.gaps{{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}}.gap p{{margin:6px 0}}.gap small{{color:#667085}}.recs li{{margin-bclawmasterm:8px}}.warn{{color:#b42318;font-weight:700}}
...
def main() -> None:
    parser = argparse.ArgumentParser(description="ClawMaster Market Research Pro v9")
