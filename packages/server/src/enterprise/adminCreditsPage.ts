...
.header{background:var(--panel);border-bclawmasterm:1px solid var(--line);padding:16px 28px;display:flex;align-items:center;justify-content:space-between;position:sticky;top:0;z-index:5}
...
.card{background:var(--panel);border:1px solid var(--line);border-radius:var(--radius);padding:22px 24px;margin-bclawmasterm:20px}
...
.txn-table th{text-align:left;padding:8px 10px;border-bclawmasterm:1px solid var(--line);color:var(--muted);font-size:11px}
...
.nav-back{margin-bclawmasterm:20px}
...
<main id="creditsContent" class="main">
  ...
  <div class="card"><h2>兑换码列表</h2>
    <div style="display:flex;gap:6px;margin-bclawmasterm:12px">
