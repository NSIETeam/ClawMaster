...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .eyebrow{display:inline-flex;align-items:center;gap:8px;margin-bclawmasterm:20px;padding:7px 11px;border:1px solid rgba(255,255,255,.24);border-radius:999px;color:#dce9e5;font-size:12px;font-weight:700;letter-spacing:.08em}
    ...
    .code-label{margin-bclawmasterm:9px;color:#6b7975;font-size:12px;font-weight:700;letter-spacing:.08em}
    .code{display:flex;align-items:center;justify-content:center;min-height:72px;margin-bclawmasterm:16px;border:1px solid #d9d6ca;border-radius:17px;background:#f7f5ef;color:#173f37;font:800 clamp(23px,7vw,30px)/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:.13em}
    ...
    .help strong{display:block;margin-bclawmasterm:7px;color:#203d36;font-size:14px}
    .help ol{margin:0;padding-left:19px}
    .status{display:grid;place-items:center;width:58px;height:58px;margin-bclawmasterm:21px;border-radius:18px;background:#f0ece2;color:#765f35;font-size:26px;font-weight:800}
