    ...
    <section id="organizationPanel" class="hidden" aria-live="polite">
      ...
      <section class="card" id="platformParkCard" aria-label="当前企业产业园设置">
        ...
        <div id="platformParkDetails" class="hidden">
          <div id="platformParkSummary" class="department" style="margin-bclawmasterm:10px"></div>
          <form id="platformParkEditForm" class="department hidden" style="margin-bclawmasterm:10px">
...
<script>
const KEY='clawmaster.enterprise.platform.session';
