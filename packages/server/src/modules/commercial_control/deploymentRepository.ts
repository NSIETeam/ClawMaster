...
const LICENSE_ENCRYPTED_SECRETS_FIELD = '_clawmasterEncryptedSecretsV1'
  ...
  try {
    ...
    const response = await fetchImpl(endpoint, {
      ...
      headers: {
        ...
        'content-type': 'application/json',
        'user-agent': 'ClawMaster-Private-Deployment/1',
        'x-clawmaster-timestamp': String(requestTimestamp),
        'x-clawmaster-nonce': requestNonce,
        'x-clawmaster-signature': signTelemetryRequest({
