    ...
    try {
      const receipt = services.ingestTelemetryBatch(
        ...
        typeof req.headers.authorization === 'string'
          ...
          : undefined,
        {
          timestamp: typeof req.headers['x-clawmaster-timestamp'] === 'string'
            ? req.headers['x-clawmaster-timestamp']
            : undefined,
          nonce: typeof req.headers['x-clawmaster-nonce'] === 'string'
            ? req.headers['x-clawmaster-nonce']
            : undefined,
          signature: typeof req.headers['x-clawmaster-signature'] === 'string'
