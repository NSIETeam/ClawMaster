...
export const en = {
  ...
  welcomeProductTitle: 'Welcome to {product}',
  welcomeProductBody: 'Configure model providers and API keys in Models settings. You can change these settings whenever you need.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  creating: '创建中\u2026',
  welcomeTitle: '内测声明',
  welcomeProductTitle: '欢迎使用 {product}',
  welcomeProductBody: '你可以在模型设置中配置模型提供方和 API 密钥，并随时调整这些设置。',
