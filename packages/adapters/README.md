...
import { MemoryProvider, MemoryScope } from 'clawmaster-core';
...
```json
{
  "name": "clawmaster-adapter-my-custom",
  "version": "1.0.0",
  "private": true,
  "description": "ClawMaster adapter: my custom memory backend",
  "type": "module",
  "main": "index.ts",
  "peerDependencies": {
    "clawmaster-core": "*"
...
- [ ] Implements a core interface (imported from `packages/core/` or `clawmaster-core`)
