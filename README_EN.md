...
> ℹ️ **Rebranding notice**: This project was previously known as **EasyCode** and has been renamed to **ClawMaster**.
...
<img src="docs/assets/demo.gif" alt="ClawMaster Demo" width="800">
...
**ClawMaster** is a revolutionary AI-powered intelligent software engineering assistant that deeply integrates artificial intelligence technology to comprehensively enhance software development efficiency, quality, and innovation.

Unlike traditional code completion tools, ClawMaster is an intelligent agent capable of **understanding the entire project context** and **autonomously orchestrating tools to complete complex tasks**, freeing developers from tedious, repetitive work to focus on higher-level innovation and problem-solving.
...
```bash
# Clone repository
git clone https://github.com/OrionStarAI/ClawMasterCode.git
cd ClawMaster
...
If you want to deploy the ClawMaster server locally or in a private environment, you can use our open-source version:

**Open Source Server:** [ClawMaster-Server-mini](https://github.com/OrionStarAI/ClawMasterCode-Server-mini)
...
# Use specific model
clawmaster -m gemini-2.0-flash

# Execute single prompt (non-interactive mode)
clawmaster -p "Explain the architecture of this project"
...
ClawMaster provides two VS Code extensions for enhanced IDE integration:
...
ClawMaster's AI interacts with the external environment through an extensible tool system:
...
**Model Context Protocol (MCP)** is the core protocol for ClawMaster's deep context understanding.
...
ClawMaster supports configuring custom models with OpenAI-compatible and Anthropic Claude API formats, allowing you to use any compatible AI service.
...
- Full integration with all ClawMaster features

⚠️ **Notes:**
- Custom models don't consume ClawMaster credits
...
- 📘 **[Whitepaper](./ClawMaster_Code_Whitepaper.md)** - Complete product and technical documentation
...
> 💡 **Tip**: We recommend using `clawmaster` for self-development. The project's `EASYCODE.md` provides development guidelines for the AI model.
...
If you find bugs or have feature suggestions, please [create an Issue](https://github.com/OrionStarAI/ClawMasterCode/issues).

---

## ⭐ Star History

[![Star History Chart](https://api.star-history.com/svg?repos=OrionStarAI/ClawMasterCode&type=date&legend=top-left)](https://www.star-history.com/#OrionStarAI/ClawMasterCode&type=date&legend=top-left)
...
- 🌐 **Official Website**: [https://www.clawmaster.bot](https://www.clawmaster.bot)
- 📦 **npm Package**: [easycode-ai](https://www.npmjs.com/package/easycode-ai)
- 🖥️ **Open Source Server**: [ClawMaster-Server-mini](https://github.com/OrionStarAI/ClawMasterCode-Server-mini)
- 🐦 **Issue Tracker**: [GitHub Issues](https://github.com/OrionStarAI/ClawMasterCode/issues)
