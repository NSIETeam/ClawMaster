...
AI inspection remains read-only until a new mutation receives approval. Human saves retain their authentication and transaction behavior. Search can scan the selected collection to count matches; explicit backup/restore retains whole-store allocation. The [frontend limitations](../../../../frontends/dsh/README.md#known-limitations-and-deferred-work) do not promise unrestricted large-database capacity.
