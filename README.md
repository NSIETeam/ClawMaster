...
Use the assets attached to a version in [GitHub Releases](https://github.com/NSIETeam/ClawMaster-Desktop/releases). Each release includes `SHA256SUMS.txt`; build results and release notes state the platform evidence and signing status.
