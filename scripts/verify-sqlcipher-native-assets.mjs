...
export function verifySqlCipherNativeTarget(
  ...
  for (const [property, expected] of [
    ['clawmaster:target', target],
    ['clawmaster:buildCommit', manifest.buildCommit],
    ['clawmaster:sourceRevision', manifest.sourceRevision],
    ['clawmaster:electronVersion', manifest.runtimeVersion],
    ['clawmaster:electronModuleAbi', manifest.toolchain.electronModuleAbi],
  ]) {
