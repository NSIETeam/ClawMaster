...
export function violationFor(fromRel, specifier) {
  ...
  if (specifier.includes('/core/src/') || specifier.match(/^\.\.\/\.\.\/core\/src\//)) {
    return 'cross-package core source import must use clawmaster-core public exports';
  }
  ...
  if (fromPackage === 'desktop' && specifier.startsWith('clawmaster-server/')) {
    return 'desktop must import clawmaster-server through public package exports';
  }
  return null;
}
