...
const LOGO = `
${COLORS.cyan}${COLORS.bright}ClawMaster Maintenance & Cleanup Utility${COLORS.reset}
`;
...
// Webpack
const webpackCache = join(os.tmpdir(), 'clawmaster-renderer-webpack-cache');
if (existsSync(webpackCache)) {
  rmSync(webpackCache, RMRF_OPTIONS);
  printItem('success', '<System Temp>/clawmaster-renderer-webpack-cache', 'Webpack Cache');
}
