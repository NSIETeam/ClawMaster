...
| Foreground model invocation | tool-free temporary ClawMaster chat with MCP, tools and ambient environment disabled | `customerModuleModelAdapter.test.ts`; provider and Token attribution asserted; pre-call cancellation asserted |
