...
ClawMaster separates server-side key custody from client E2EE. The server key
...
credentials, SDK clients, PKCS#11 PINs, and sessions remain outside ClawMaster's
