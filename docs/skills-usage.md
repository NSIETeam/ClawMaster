# ClawMaster Skills System User Guide / ClawMaster Skills System 使用指南
...
This document details the architecture and usage of the Skills system in ClawMaster.
...
The ClawMaster CLI introduces the `/skill` command family to manage the entire lifecycle.
...
ClawMaster CLI 新增了 `/skill` 命令族，用于管理整个生命周期。
