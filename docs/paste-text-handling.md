# ClawMaster CLI 输入组件 - 粘贴文本处理机制

## 概述

ClawMaster CLI 输入组件实现了一套完整的大量文本粘贴处理机制，包括智能检测、自动摘要、防抖合并和无缝还原等功能。本文档详细介绍了这套机制的核心逻辑和实现细节。
...
*该文档基于 ClawMaster CLI v1.0.67 版本编写，如有更新请参考最新代码实现。*