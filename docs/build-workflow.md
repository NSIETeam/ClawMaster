# ClawMaster 构建工作流程 / Build Workflow

本文档介绍 ClawMaster 项目的构建和开发工作流程，包含中英双语说明。

This document describes the build and development workflow for the ClawMaster project, with bilingual instructions.

## 📋 项目结构 / Project Structure

ClawMaster 采用 npm workspaces 的 monorepo 架构：

ClawMaster uses a monorepo architecture with npm workspaces:
