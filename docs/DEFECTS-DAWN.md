...
**基线**：dsh 0.1.5-rc.2（harness `72da6c767414dd30`）· desktop 0.2.3 · 本文档对齐本地稳定运行版本
**更新**：2026-09-21
...
| D8 | **版本号硬编码漂移**：`packages/server/src/server.ts` appVersion=0.0.2beta ≠ 0.1.5-rc.2 | 版本一致性门禁红灯 | 门禁测试存在但未进 CI | 从 package.json 注入 |
