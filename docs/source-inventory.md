...
| Runtime kernel | `packages/core/src/index.ts`, `packages/core/src/core/*` | `packages/core/src/**/*.test.ts` | `clawmaster-core` workspace dependency | `packages/core` | keep, enforce kernel boundary | #90 |
...
| Mem0 adapter | `packages/adapters/mem0/index.ts` | none in adapter package | optional memory adapter | `packages/adapters/mem0` | keep but move imports to public `clawmaster-core` exports | #90 |
...
| ClawMaster pet atlas | `packages/desktop/src/renderer/assets/clawmaster-pet-atlas.png` | visual smoke/manual | renderer pet/avatar surfaces | `packages/desktop` | keep pending compression audit | #89 |
| ClawMaster avatar | `packages/desktop/src/renderer/assets/clawmaster-avatar.png` | renderer tests/manual | renderer identity surfaces | `packages/desktop` | keep pending compression audit | #89 |
