...
Issue: [#152](https://github.com/Felix201209/clawmaster/issues/152)

ClawMaster 采用模块化单体架构。模块用于建立代码、数据、权限、License、更新和审计边界，
...
默认仍将业务模块编译到同一个 ClawMaster Server，保证私有化部署简单。只有控制面、客户数据面和
